...
nb_JT = 2:7;            % size of CoMP cluster
...
Net_avail_bu = sum((Etot_bu <= E_th).*(Dtot_bu <= D_th))/(n_smp*n_itr);
Net_avail_Kuu = sum((Etot_Kuu <= E_th).*(Dtot_Kuu <= D_th),2)/(n_smp*n_itr);
Net_avail_BU1 = sum((Etot_BU1 <= E_th).*(Dtot_BU1 <= D_th))/(n_smp*n_itr);
Net_avail_BU2 = sum((Etot_BU2 <= E_th).*(Dtot_BU2 <= D_th))/(n_smp*n_itr);
Net_avail_BU3 = sum((Etot_BU3 <= E_th).*(Dtot_BU3 <= D_th))/(n_smp*n_itr);

Net_avail_hu = sum((Etot_hu <= E_th).*(Dtot_hu <= D_th))/(n_smp*n_itr);
Net_avail_BH = sum((Etot_BH <= E_th).*(Dtot_BH <= D_th))/(n_smp*n_itr);
Net_avail_BHU1 = sum((Etot_BHU1 <= E_th).*(Dtot_BHU1 <= D_th))/(n_smp*n_itr);
Net_avail_BHU2 = sum((Etot_BHU2 <= E_th).*(Dtot_BHU2 <= D_th))/(n_smp*n_itr);
Net_avail_BHU3 = sum((Etot_BHU3 <= E_th).*(Dtot_BHU3 <= D_th))/(n_smp*n_itr);

Net_avail_su_S = sum((Etot_su_S <= E_th).*(Dtot_su_S <= D_th))/(n_smp*n_itr);
Net_avail_BS_S = sum((Etot_BS_S <= E_th).*(Dtot_BS_S <= D_th))/(n_smp*n_itr);
Net_avail_BSU1_S = sum((Etot_BSU1_S <= E_th).*(Dtot_BSU1_S <= D_th))/(n_smp*n_itr);
Net_avail_BSU2_S = sum((Etot_BSU2_S <= E_th).*(Dtot_BSU2_S <= D_th))/(n_smp*n_itr);
Net_avail_BSU3_S = sum((Etot_BSU3_S <= E_th).*(Dtot_BSU3_S <= D_th))/(n_smp*n_itr);

Net_avail_su_Ka = sum((Etot_su_Ka <= E_th).*(Dtot_su_Ka <= D_th))/(n_smp*n_itr);
Net_avail_BS_Ka = sum((Etot_BS_Ka <= E_th).*(Dtot_BS_Ka <= D_th))/(n_smp*n_itr);
Net_avail_BSU1_Ka = sum((Etot_BSU1_Ka <= E_th).*(Dtot_BSU1_Ka <= D_th))/(n_smp*n_itr);
Net_avail_BSU2_Ka = sum((Etot_BSU2_Ka <= E_th).*(Dtot_BSU2_Ka <= D_th))/(n_smp*n_itr);
Net_avail_BSU3_Ka = sum((Etot_BSU3_Ka <= E_th).*(Dtot_BSU3_Ka <= D_th))/(n_smp*n_itr);

%========================= mean error analysis ============================
mean_Etot_bu = mean(Etot_bu);
mean_Etot_uu = mean(Etot_Kuu(1,:));
mean_Etot_BU1 = mean(Etot_BU1);
mean_Etot_BU2 = mean(Etot_BU2);
mean_Etot_BU3 = mean(Etot_BU3);

mean_Etot_hu = mean(Etot_hu);
mean_Etot_BH = mean(Etot_BH);
mean_Etot_BHU1 = mean(Etot_BHU1);
mean_Etot_BHU2 = mean(Etot_BHU2);
mean_Etot_BHU3 = mean(Etot_BHU3);

mean_Etot_su_S = mean(Etot_su_S);
mean_Etot_BS_S = mean(Etot_BS_S);
mean_Etot_BSU1_S = mean(Etot_BSU1_S);
mean_Etot_BSU2_S = mean(Etot_BSU2_S);
mean_Etot_BSU3_S = mean(Etot_BSU3_S);

mean_Etot_su_Ka = mean(Etot_su_Ka);
mean_Etot_BS_Ka = mean(Etot_BS_Ka);
mean_Etot_BSU1_Ka = mean(Etot_BSU1_Ka);
mean_Etot_BSU2_Ka = mean(Etot_BSU2_Ka);
mean_Etot_BSU3_Ka = mean(Etot_BSU3_Ka);
