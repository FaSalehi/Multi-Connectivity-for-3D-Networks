...
n_itr = 1e3;       % number of iterations
Eb = [1e-6, 1e-5];         % backhual failure probability
...
Dtot_bu_samples(ii,:) = Dtot_bu;
Dtot_uu_samples(ii,:) = Dtot_Kuu(1,:);
Dtot_bu_JT_samples(ii,:) = Dtot_bu_JT;
Dtot_Kuu_JT_samples(ii,:) = Dtot_Kuu_JT(1,:);
Dtot_hu_samples(ii,:) = Dtot_hu;
Dtot_su_S_samples(ii,:) = Dtot_su_S;
Dtot_su_Ka_samples(ii,:) = Dtot_su_Ka;
