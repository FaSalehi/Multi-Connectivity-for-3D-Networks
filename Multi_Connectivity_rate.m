...
Nc = 4;              % number of RB allocated to each user (allocated bandwidth < = coherence BW (1.2 MHz)) Nc={1,...,6}
Nf = 1;              % frequency diversity factor for BU links: {1,2}

BW_bu_tot = 10e6;    % total bandwidth of BU (Hz) ---> 50 PRB
BW_bu = Nc*BW_RB;    % bandwidth of each BU link (Hz)
...
Eb = 1e-5;         % backhual failure probability
...
ii = 1;
for R = [100e3:10e3:390e3,400e3:50e3:950e3,1e6:100e3:3.9e6,4e6:500e3:10e6]
